...
void PlaySnake() {  // aqui a função que substituiu o void loop!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  if (!snakeIniciado) {
    Snake_Init();  // roda só uma vez
...
// eu acho que isso é pra depuração, mas aí não é problema meu
